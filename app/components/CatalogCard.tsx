...
export default function CatalogCard({
  ...
  const businessSettingsUrl = `https://business.facebook.com/latest/settings/product_catalogs?business_id=${business_id}&selected_asset_id=${catalog_id}&selected_asset_type=product-catalog`;
  const commerceManagerUrl = `https://business.facebook.com/commerce/catalogs/${catalog_id}/products?business_id=${business_id}`;
      ...
      <div className="flex-1">
        ...
        <div className="space-y-1">
          <p className="text-sm text-gray-600">
            ...
            <span className="text-gray-700">{catalog_id}</span>
          </p>
          <p className="text-sm text-gray-600">
